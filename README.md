...
テーマは「段取りのアウトソーシング」です。ごみ分別専用にはせず、日常の相談を幅広く受け、必要に応じて確認・調査・整理しながら次の行動を一緒に決めます。回答役は、小さな案内役の「ヤドカリさん」です。

リポジトリ名とWorker名は旧称の `kodomo-shiyakusho` を維持し、利用者向けの画面と会話人格をヤドカリさんへ変更しています。
...
- トランシーバー中央にヤドカリさんの肖像を表示し、話している相手を明確にする。
...
- トランシーバーで話す小さな案内役の「ヤドカリさん」として話す。
- 親しみやすく、落ち着いた自然な敬語を使う。
- ヤドカリを強調した語尾や駄洒落は使わない。
...
- ブラウザから送る履歴は1件最大800文字へ丸める。
- Workerは各メッセージ最大1,000文字、履歴全体最大6,000文字として検証する。
...
| 2026-08-28 | 案内役をこども職員から「ヤドカリさん」へ変更し、画面・履歴・AI人格を統一する |
